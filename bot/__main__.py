...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Owner", "https://t.me/Praston25")
    buttons.buildbutton("Made By", "https://t.me/SuperGodX")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
Heyo, This Bot is made for Prasetyo By Mr. X, 
If you are not Prasetyo then Fuck Off!!!
This bot can mirror all your links to Google Drive!
Type /{BotCommands.HelpCommand} to get a list of available commands
'''
        sendMarkup(start_string, context.bot, update.message, reply_markup)
    else:
        sendMarkup('Not Authorized user, Fuck You', context.bot, update.message, reply_markup)
